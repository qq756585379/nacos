...
public class Member implements Comparable<Member>, Cloneable {
    ...
    public Member() {
        ...
        extendInfo.put("site", ApplicationUtils.getProperty("nacos.core.member.meta.site", "unknow"));
        extendInfo.put(MemberMetaDataConstants.AD_WEIGHT, ApplicationUtils.getProperty(prefix + MemberMetaDataConstants.AD_WEIGHT, "0"));
        extendInfo.put(MemberMetaDataConstants.WEIGHT, ApplicationUtils.getProperty(prefix + MemberMetaDataConstants.WEIGHT, "1"));
    }
